...
static esp_err_t camera_init(uint32_t xclk_freq_hz, pixformat_t pixel_format, framesize_t frame_size, int jpeg_quality, uint8_t fb_count)
{
    ...
    static pixformat_t cur_pixel_format = (pixformat_t) 0;
    static framesize_t cur_frame_size = (framesize_t) 0;
...
static uvc_fb_t* camera_fb_get_cb(void *cb_ctx)
{
    ...
    s_fb.uvc_fb.format = (uvc_format_t) s_fb.cam_fb_p->format;
